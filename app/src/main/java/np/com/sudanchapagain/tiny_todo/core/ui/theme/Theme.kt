...
private val LightColors = lightColorScheme(
    ...
    primary = Blue600, onPrimary = White,

    primaryContainer = Blue100, onPrimaryContainer = Blue950,

    secondary = Slate600, onSecondary = White,

    secondaryContainer = Slate100, onSecondaryContainer = Slate900,

    tertiary = Violet600, onTertiary = White,

    tertiaryContainer = Violet100, onTertiaryContainer = Violet950,

    background = Slate100, onBackground = Slate900,

    surface = White, onSurface = Slate950,

    surfaceVariant = Slate200, onSurfaceVariant = Slate700,

    outline = Slate400, outlineVariant = Slate300,

    error = Red600, onError = White,

    errorContainer = Red100, onErrorContainer = Red950
)
...
private val DarkColors = darkColorScheme(
    ...
    primary = Blue400, onPrimary = Blue950,

    primaryContainer = Blue800, onPrimaryContainer = Blue100,

    secondary = Slate400, onSecondary = Slate950,

    secondaryContainer = Slate800, onSecondaryContainer = Slate100,

    tertiary = Violet400, onTertiary = Violet950,

    tertiaryContainer = Violet800, onTertiaryContainer = Violet100,

    background = Slate900, onBackground = Slate200,

    surface = Slate800, onSurface = Slate100,

    surfaceVariant = Slate700, onSurfaceVariant = Slate300,

    outline = Slate500, outlineVariant = Slate700,

    error = Red400, onError = Red950,

    errorContainer = Red800, onErrorContainer = Red100
)

@Composable
fun successColor(): Color = if (isSystemInDarkTheme()) Indigo500 else Indigo500
